...
/cluster/home/peterhor/ctsm/tools/mkmapdata/
module load ncl

check for centercoordinates and dx dy from 
./mknoocnmap.pl -centerpoint 61.485625,8.84549 -name Jotunheimen_noocean -dx 0.00406 -dy 0.00211 

./gen_domain -m /cluster/home/peterhor/ctsm/tools/mkmapdata/map_Jotunheimen_noocean_noocean_to_Jotunheimen_noocean_nomask_aave_da_190111.nc -o jotunheimen_ocn -l jotunheimen_lnd
             [-p set_fv_pole_yc]
             [-c <user comment gen_domain.nml>]

### noocean also this also generates script grid


###atm files were generated by HUI so far
# atm are in /work/users/peterhor/inputdata/atm/datm7/Jotunheimen/

# continue in the case directory /cluster/home/peterhor/ctsm_cases/fates_jotunheimen/

always checking these files
env_mach_pes > change CPU if necessary
env_batch > change wallcloct time line76 increase to 
env_run >  
	<entry id="RUN_STARTDATE" value="1990-01-01">
	<entry id="GMAKE_J" value="8">
		#name of file
      <entry id="ATM_DOMAIN_FILE" value="UNSET">  domain.lnd.jotunheimen_lnd_jotunheimen_ocn.190111.nc
#copy domain file into this folder
	      <entry id="ATM_DOMAIN_PATH" value="$DIN_LOC_ROOT/share/domains">

cp /cluster/home/peterhor/ctsm/cime/tools/mapping/gen_domain_files/domain.lnd.jotunheimen_lnd_jotunheimen_ocn.190111.nc /work/users/peterhor/inputdata/share/domains/

line 766 specifies the inputdata
<entry id="DIN_LOC_ROOT" value="/work/users/$USER/inputdata">
	<entry id="DATM_MODE" value="CLM1PT">

line 1282 onwards setting up dates for forcing data

line 1309 <entry id="LND_TUNING_MODE" value="clm5_0_GSWP3v1"> WHAT were atmospheric data based on 
line 	<entry id="CLM_USRDAT_NAME" value="1x1_km"> string to describe file (not file name nor path)
	
copy this surface file to 
	cp /cluster/home/peterhor/ctsm/tools/mksurfdata_map/surfdata_1x1_km_hist_16pfts_Irrig_CMIP6_simyr2000_c190111.nc /work/users/peterhor/inputdata/lnd/clm2/surfdata_map/

./case.setup --reset
./case.build --clean-all
./case.build

surfdat default file path in namelist_defaults_overall.xml located /cluster/home/peterhor/ctsm/bld/namelist_files/
changed and added:
